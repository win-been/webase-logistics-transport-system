...
const transitMenu = [
    ...
    { path: '/transit/form', title: "运单中心", icon: IconEpTickets, submenu: [
        { path: '/transit/transitformList', title: '我的运单', icon: IconEpFiles }, 
        { path: '/transit/transitattendformList', title: '参与运单', icon: IconEpVan }, 
        { path: '/transit/transitcreateform', title: '创建运单', icon: IconEpPlus }, 
        { path: '/transit/transitsearchform', title: '运单查询', icon: IconEpSearch }, 
        { path: '/transit/transitformtrack', title: '物流追踪', icon: IconEpMapLocation },
        { path: '/transit/transittemplate', title: '常用模板', icon: IconEpDocument }
    ]},
    ...
    { path: '/transit/contacts', title: '用户通讯录', icon: IconEpNotebook, submenu: [{ path: '/transit/transituserlist', title: '用户列表', icon: IconEpUser }] },
];
const adminMenu = [
    { path: '/admin/home', title: "系统首页", icon: IconEpHomeFilled, submenu: [] },
    { path: '/admin/info', title: "我的信息", icon: IconEpHouse, submenu: [{ path: '/admin/admininfo', title: '我的信息', icon: IconEpDocument }, ] },
    { path: '/admin/form', title: "运单中心", icon: IconEpTickets, submenu: [{ path: '/admin/adminallformList', title: '库内运单', icon: IconEpFiles },{path: '/admin/admincreateform', title: '创建表单', icon: IconEpEdit },{path: '/admin/adminsearchform', title: '搜索表单', icon: IconEpSearch },{path: '/admin/adminformtrack', title: '运单追踪', icon: IconEpMapLocation }]},
    ...
    routes: [
        ...
        },
        {
            ...
            children: [
                ...
                {
                    path: 'transituserlist',
                    name: 'transitUserList',
                    component: () => import('../components/content/transit/transitUserList.vue'),
                },
                {
                    path: 'transitdashboard',
                    name: 'transitDashboard',
                    component: () => import('../components/content/transit/transitDashboard.vue'),
                },
                {
                    path: 'transitformtrack',
                    name: 'transitFormTrack',
                    component: () => import('../components/content/transit/transitFormTrack.vue'),
                },
                {
                    path: 'transittemplate',
                    name: 'transitTemplate',
                    component: () => import('../components/content/transit/transitTemplate.vue'),
                }
            ]
        },
        {
            ...
            children: [
                {
                    path: 'home',
                    name: 'adminHome',
                    component: () => import('../components/content/admin/adminHome.vue'),
                },
                {
                    path: 'admininfo',
                    name: 'adminInfo',
                ...
                },
                {
                    path: 'adminformtrack',
                    name: 'adminFormTrack',
                    component: () => import('../components/content/admin/adminFormTrack.vue'),
                },
                {
