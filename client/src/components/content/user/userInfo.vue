      ...
      <el-col :span="8">
        <el-card class="profile-card" shadow="hover">
          <div class="avatar-section">
            ...
            <el-tag type="success" effect="dark" round>{{ getRoleLabel(userInfo.role) }}</el-tag>
          </div>
          ...
          <div class="quick-actions">
            <el-button type="success" @click="$router.push('/user/userchangeinfo')" class="action-btn">
        ...
        <el-card class="security-card" shadow="hover">
          ...
          <div class="security-list">
            <div class="security-item">
              ...
              <el-button text type="primary" size="small" @click="$router.push('/user/userchangeinfo')">修改</el-button>
            </div>
            <div class="security-item">
              <div class="security-left">
                <el-icon class="status-icon success"><i-ep-CircleCheckFilled /></el-icon>
        ...
        <el-card class="stats-card" shadow="hover">
          ...
          <div class="work-stats">
            <div class="work-stat-item">
              <div class="work-stat-icon" style="background: linear-gradient(135deg, #10b981 0%, #059669 100%);">
                <el-icon><i-ep-Document /></el-icon>
              </div>
              <div class="work-stat-info">
                <span class="work-stat-value">{{ stats.totalForms }}</span>
                <span class="work-stat-label">全部运单</span>
              </div>
            </div>
            <div class="work-stat-item">
              <div class="work-stat-icon" style="background: linear-gradient(135deg, #3b82f6 0%, #1d4ed8 100%);">
                <el-icon><i-ep-Van /></el-icon>
              </div>
              <div class="work-stat-info">
                <span class="work-stat-value">{{ stats.pendingForms }}</span>
                <span class="work-stat-label">运输中</span>
              </div>
            </div>
            <div class="work-stat-item">
              <div class="work-stat-icon" style="background: linear-gradient(135deg, #8b5cf6 0%, #6d28d9 100%);">
...
const fetchStats = async () => {
  try {
    const res = await axios.post('/api/getUserForm', { userAddr: info.address });
