<template>
  <div class="content">
    ...
    <div class="page-header">
      ...
      <p class="page-desc">查看您的所有运单记录</p>
    </div>
    ...
    <div class="stats-row">
      <div class="stat-card">
        ...
        <div class="stat-info">
          ...
          <span class="stat-label">运单总数</span>
        </div>
      </div>
      <div class="stat-card">
        ...
        <div class="stat-info">
          <span class="stat-value">{{ tableData.filter(item => item.status === 'on').length }}</span>
      ...
      <div class="stat-card">
        ...
        <div class="stat-info">
          <span class="stat-value">{{ tableData.filter(item => item.status === 'off').length }}</span>
