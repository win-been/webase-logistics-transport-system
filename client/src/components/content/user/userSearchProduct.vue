...
.page-header {
    ...
    .page-desc { color: rgba(255, 255, 255, 0.85); margin: 8px 0 0 0; font-size: 14px; }
}
...
.search-wrapper {
    ...
    .el-input { flex: 1; :deep(.el-input__wrapper) { box-shadow: 0 2px 8px rgba(0, 0, 0, 0.08); } }
}
...
.search-tips {
    ...
    border-left: 3px solid #0ea5e9; color: #0369a1; font-size: 13px;
...
.card-header {
    ...
    .header-left {
        ...
        .el-icon { color: #11998e; }
    }
}

.custom-table :deep(.el-table__header th) { background: #fafafa !important; color: #606266; font-weight: 600; }

.product-name { display: flex; align-items: center; gap: 8px; .el-icon { color: #11998e; } }

.address-text {
    font-family: monospace; font-size: 12px; color: #909399; cursor: pointer;
    &:hover { color: #11998e; }
}
</style>
