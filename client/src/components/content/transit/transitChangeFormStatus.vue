<template>
  <div class="content">
    ...
    <div class="page-header">
      ...
      <p class="page-desc">管理运单状态，结束运输中的表单</p>
    </div>
    ...
    <el-card class="main-card" shadow="hover">
      ...
      <el-table
          ...
          >
            ...
            <el-table-column prop="status" label="操作" width="150" fixed="right">
              <template #default={row}>
                <el-button v-if="row.status==='off'" disabled type="info" size="small">
                  <el-icon><i-ep-Lock /></el-icon>
                  已停用
                </el-button>
                <el-button v-if="row.status==='on'" @click="handleStop(row)" type="danger" size="small">
