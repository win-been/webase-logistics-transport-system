  ...
  <div class="content">
    ...
    <div class="page-header">
      <div class="header-left">
        ...
        <p class="page-desc">查看和管理所有在库商品信息</p>
      </div>
    ...
    <el-card class="main-card" shadow="hover">
      ...
      >
        ...
        <el-table-column prop="productAddr" label="区块链地址" min-width="180">
          <template #default={row}>
            <el-tooltip :content="row.productAddr" placement="top">
              <span class="address-text">{{ row.productAddr?.slice(0, 10) }}...{{ row.productAddr?.slice(-8) }}</span>
            </el-tooltip>
          </template>
        </el-table-column>
    ...
    <!-- 条码查询对话框 -->
    <el-dialog v-model="dialogVisible" title="条码查询" width="450" class="barcode-dialog">
      <div class="dialog-content">
        <img src="@/assets/gs1_logo.png" class="gs1-logo" />
        <p>您即将前往<strong>中国商品信息服务平台</strong>查询条码数据</p>
        <p class="barcode-value">条码：{{ searchBarcode }}</p>
      </div>
      <template #footer>
